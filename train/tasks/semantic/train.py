...
if __name__ == '__main__':
    ...
    try:
        ...
        copyfile("./modules/MetaRangeSeg.py", FLAGS.log + "/MetaRangeSeg.py")
        copyfile("./modules/trainer.py", FLAGS.log + "/trainer.py")
        copyfile("./dataset/kitti/parser.py", FLAGS.log + "/parser.py")
