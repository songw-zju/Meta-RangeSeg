...
class LaserScan:
    ...
    def __init__(self, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0,DA=False,flip_sign=False,rot=False,drop_points=False, training=False):
    ...
    def do_range_projection(self):
        ...
        depth = np.linalg.norm(self.points, 2, axis=1) + 1e-10
        ...
        # assing to images
        if proj_y.min() < 0 or proj_y.max() > 63:
            print(proj_y.shape)
...
class SemLaserScan(LaserScan):
    ...
    def __init__(self, sem_color_dict=None, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0, max_classes=300,DA=False,flip_sign=False,drop_points=False, training=False):
        super(SemLaserScan, self).__init__(project, H, W, fov_up, fov_down,DA=DA,flip_sign=flip_sign,drop_points=drop_points,training=training)
        self.reset()
