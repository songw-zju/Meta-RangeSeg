...
basedir = '/home/ws/data/semantic_kitti/dataset'
sequence = '00'
uncerts = ''
preds = ''
gt = ''
...
color_map_dict = yaml.safe_load(open("/home/ws/project/point_cloud/SalsaNext/train/tasks/semantic/config/labels/semantic-kitti.yaml"))['color_map']
learning_map = yaml.safe_load(open("/home/ws/project/point_cloud/SalsaNext/train/tasks/semantic/config/labels/semantic-kitti.yaml"))['learning_map']
color_map = {}
